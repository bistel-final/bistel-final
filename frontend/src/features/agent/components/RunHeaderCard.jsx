...
import { approvalStatusSummary, runStatusText } from './agentModel.js'
...
function RunHeaderCard({ run, action, approval }) {
  ...
  return (
    <Card className="agent-main-readable px-5 py-4">
      <div className="flex items-start justify-between">
        <div>
          <div className="font-mono text-[15px] font-extrabold text-ink">{run.agent_run_id}</div>
