...
export const CORE_CHAMBER_GRAPH = Object.freeze({
  context: {
    ...
    relation_ids: [
      ...
      'REL-83f00f4fb4f6ed30f55d',
      'REL-100c4c642c9c9a3c71e6',
      'REL-939dd36634df593cbd27',
      'REL-37afa7aa83316d29b4d5',
      'REL-396394b56797636804b3',
      'REL-02c877314abc4f84f39d',
    ],
  },
  ...
  nodes: [
    ...
    {
      node_id: 'Chamber:EQP01-PM2',
      label: 'Chamber',
      business_id: 'EQP01-PM2',
      name: 'EQP01-PM2',
      properties: { chamber_id: 'EQP01-PM2' },
    },
    {
      node_id: 'Equipment:EQP01',
      label: 'Equipment',
      business_id: 'EQP01',
      name: 'EQP01',
      properties: { equipment_id: 'EQP01', area: 'Photo', model_code: 'PH-9000' },
    },
    {
      node_id: 'EquipmentModel:PH-9000',
      label: 'EquipmentModel',
      business_id: 'PH-9000',
      name: 'Photo Scanner',
      properties: { model_code: 'PH-9000', model_name: 'Photo Scanner' },
    },
    {
      node_id: 'Area:Photo',
      label: 'Area',
      ...
      properties: { area_id: 'Photo', area_name: 'Photolithography' },
    },
    {
      node_id: 'ProcessStep:CT-PHOTO',
      label: 'ProcessStep',
      business_id: 'CT-PHOTO',
      name: 'CT-PHOTO',
      properties: { step_id: 'CT-PHOTO', step_seq: 1 },
    },
    {
      node_id: 'ProcessStep:CT-ETCH',
      label: 'ProcessStep',
      business_id: 'CT-ETCH',
      name: 'CT-ETCH',
      properties: { step_id: 'CT-ETCH', step_seq: 2 },
    },
    {
      ...
      business_id: 'PH_DEV',
      name: 'PH_DEV',
      properties: { parameter_id: 'PH_DEV' },
    },
    {
      ...
      business_id: 'PH_DOSE',
      name: 'PH_DOSE',
      properties: { parameter_id: 'PH_DOSE' },
    },
    {
      ...
      name: 'PH_FOCUS',
      properties: { parameter_id: 'PH_FOCUS' },
    },
    {
      ...
      business_id: 'PH_PEB',
      name: 'PH_PEB',
      properties: { parameter_id: 'PH_PEB' },
    },
  ],
  relationships: [
    {
    ...
    { relation_id: 'REL-83f00f4fb4f6ed30f55d', type: 'PART_OF', from_node_id: 'Chamber:EQP01-PM1', to_node_id: 'Equipment:EQP01' },
    { relation_id: 'REL-100c4c642c9c9a3c71e6', type: 'PART_OF', from_node_id: 'Chamber:EQP01-PM2', to_node_id: 'Equipment:EQP01' },
    { relation_id: 'REL-939dd36634df593cbd27', type: 'OF_MODEL', from_node_id: 'Equipment:EQP01', to_node_id: 'EquipmentModel:PH-9000' },
    { relation_id: 'REL-37afa7aa83316d29b4d5', type: 'PERFORMS', from_node_id: 'Equipment:EQP01', to_node_id: 'ProcessStep:CT-PHOTO' },
    { relation_id: 'REL-396394b56797636804b3', type: 'IN_AREA', from_node_id: 'ProcessStep:CT-PHOTO', to_node_id: 'Area:Photo' },
    { relation_id: 'REL-02c877314abc4f84f39d', type: 'NEXT_STEP', from_node_id: 'ProcessStep:CT-PHOTO', to_node_id: 'ProcessStep:CT-ETCH' },
  ],
  node_count: 11,
