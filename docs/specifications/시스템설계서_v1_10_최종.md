...
| v1.10 | 2026-08-11 | 요구사항 v1.9와 API 명세서 v2.1 정렬 — 8화면 계약, Text2SQL 정책 거부 200 구조화 응답, `ActionApprovalStatus` 분리, Agent Fault Code 4종·nullability, readiness 실패 reason, `created_by_agent_run_id`, Sensor·Tool·평가·감사 DTO, 안정 정렬·입력 제약·DB/API 필드 매핑을 확정 |
