...
| `ApprovalItem` | `approval_id:str`, `agent_run_id:str`, `action_id:str\|null`, `incident:IncidentRef`, `equipment_id:str\|null`, `sensor_id:str\|null`, `action_code:str`, `severity:Severity\|null`, `requested_at:datetime`, `status:ApprovalStatus`, `decided_by:str\|null`, `decided_at:datetime\|null`, `decision_comment:str\|null` |
