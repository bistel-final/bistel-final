...
**대시보드 기본 조회일** `2026-06-04` (date 미지정 시 데이터 최신 일자)

```
알람 6 · OOS 6 · OOC 0 · 계측 PASS율 70.0%
챔버 상태  ETC-01-C1 CRITICAL / ETC-01-C2·PHO-01-C1·PHO-01-C2 NORMAL
AREA만 지정  PHOTO → 2026-06-03 19건 / ETCH → 2026-06-04 6건
데이터 존재 일자  2026-06-01 ~ 2026-06-04
```
...
**예외**: `ET_REFL`은 LSL=LCL=0이므로 **상한만 판정**한다 (UCL 21.0 / USL 30.0).
