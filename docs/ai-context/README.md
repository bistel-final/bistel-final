...
| source intake·epoch·manifest | `V5-CM-1.1` intake, `V5-CM-1.2` epoch 발급·구 epoch 격리, `V5-CM-1.3` source manifest v4 구현·최종검증은 기술 완료. final DB profile marker는 후속 bootstrap Task 전이므로 미생성 |
