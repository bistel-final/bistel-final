...
| C Agent/HITL | 방대혁 | 64.5h | LangGraph·조치·승인·n8n·Kafka·delivery·화면 3 |
| D Audit·확장 | 천승현 | 14.5h | 감사 read model·화면 3 감사 tab·선택 Text2SQL |
| **합계** | | **190.0h** | P2 도전 과제 제외 |

우선순위별 공수는 **P0 143.5h / P1 46.5h**이며 P2 3.5h는 합계에서 제외한다.
Task 수는 96건(P2 2건 포함)이다. 대부분의 Task는 1.0~2.0h이며 예외가 열세 개다.
