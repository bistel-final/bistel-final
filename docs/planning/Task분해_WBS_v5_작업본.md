...
| C Agent/HITL | 방대혁 | 56.5h | LangGraph·조치·승인·n8n·Kafka·delivery·화면 3 |
| D Audit·확장 | 천승현 | 14.5h | 감사 read model·화면 3 감사 tab·선택 Text2SQL |
| **합계** | | **182.0h** | P2 도전 과제 제외 |

우선순위별 공수는 **P0 135.5h / P1 46.5h**이며 P2 3.5h는 합계에서 제외한다.
